...
void RandomSystem()
{
	...
	printf("               欢迎使用电梯调度模拟系统                 \n");
	printf("            本系统随机产生每层楼有多少人                \n");
	printf("             以及那些人分别想去那个楼层                 \n");
	printf("             然后通过动画模拟电梯的调度                 \n");
	printf(">>>                                                  <<<\n");
	
	printf("简要说明：\n");
	printf("本程序设计共有十层楼，一台升降电梯因\n");
	printf("为一楼通常会比较多人因此电梯在闲置的\n");
	printf("时候会添加命令返回首层\n"); 	
	printf("\n\n\n\n点击开始模拟\n\n\n\n") ;
...
/***
模拟电梯的运行
电梯的属性: 1,当前所在楼层 2,运行方向
电梯的方法: 1,向上(或向下)运行
事件: 1,电梯内部按键 2,电梯外部按键
a,创建一个10层的电梯.dianti[2]
__Q:电梯还有最大荷载人数
b,创建绘图函数print()
c,创建电梯运动的方法调用run()
__Q:电梯运动中,改变要去的楼层,去近的新的一个楼层,算法还无法实现
***/
